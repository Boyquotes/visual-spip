 ...
 * spip.php
 * -------
 * Author: Nicolas Villa alias Boyquotes (webmaster@linux-live-cd.org)
 * Copyright: (c) 2009 Nicolas Villa @license    http://gnu.org/copyleft/gpl.html GNU GPL
 * Release Version: 1.0.8.4
 * Date Started: 2009/08/14
 *
 * SPIP language file for GeSHi.
 *
 * CHANGES
 * -------
 * 2009/08/14 (1.0.7.22)
 *  -  Start of highlighting code for SPIP

 * -------------------------
 * *  HighLighting for SPIP
 *
 *************************************************************************************
 *
...
$language_data = array(
    ...
    'KEYWORDS' => array(
        ...
        2 => array(
            ...
            'namespace','new','private','public','self','var','&lt;BOUCLE',
            ),
        3 => array(
        ...
        4 => array(
            ...
            '__LINE__', '__METHOD__'
			 ...
			 5 => array(
'ACTION_FORMULAIRE','AIDER','ANCRE_PAGINATION','ARRAY','AUTORISER','CACHE','CHAMP_SQL','CHAPO ','CHARSET','CHEMIN','COMPTEUR_BOUCLE','CONFIG','CONNECT','DATE ','DATE_MODIF ','DATE_NOUVEAUTES','DATE_REDAC ','DEBUT_SURLIGNE','DESCRIPTIF_SITE_SPIP','DOSSIER_SQUELETTE','EDIT','EMAIL_WEBMASTER','EMBED_DOCUMENT','ENV','EVAL','EXPOSE','EXPOSER','FILTRE','FIN_SURLIGNE','FOREACH','FORMULAIRE','FORMULAIRE_ADMIN ','FORMULAIRE_FORUM','FORMULAIRE_INSCRIPTION','FORMULAIRE_RECHERCHE','FORMULAIRE_SIGNATURE','FORMULAIRE_SITE','GET','GRAND_TOTAL','HTTP_HEADER','INCLUDE','INCLURE','INSERT_HEAD','INTRODUCTION','LANG ','LANG_DIR','LANG_LEFT','LANG_RIGHT','LESAUTEURS ','LOGIN_PRIVE','LOGO','MENU','MENU_LANG ','MODELE','NOM_SITE','NOM_SITE_SPIP','NOOP','NOTES','PAGINATION','PARAMETRES_FORUM','PETITION ','PIPELINE','PLUGIN','POINTS','POPULARITE ','POPULARITE_ABSOLUE','POPULARITE_MAX','POPULARITE_SITE','PUCE','RANG ','RECHERCHE','REM','RUBRIQUES', 'SELF','SESSION','SESSION_SET','SET','SPIP_CRON ','SPIP_VERSION','SQUELETTE', 'TEXTE', 'TOTAL_BOUCLE','TOTAL_UNIQUE','URL','URL_ACTION','URL_ARTICLE','URL_ECRIRE','URL_LOGOUT ','URL_PAGE', 'URL_RUBRIQUE', 'URL_SITE','VAL'
            ),
			6 => array(
            'attribut_html','annee','vider_attribut','agenda_affiche','affdate_mois_annee','affdate_jourcourt',
			'affdate_court','affdate','abs_url','choixsiegal','concat',
			'couleur_saturation','couleur_4096','couleur_web','couleur_eclaircir',
			'couleur_foncer','couleur_extreme','choixsivide','direction_css','majuscules',
			'justifier','aligner_droite','centrer','liens_ouvrants','paragrapher','supprimer_tags',
			'textebrut','reduire_image','url_absolue','sinon','?{','image_typo','image_aplatir',
			'image_format','compacte_head','supprimer_numero'
            ),
			7 => array(
			'age', 'annee', 'branche','date','date_redac','doublons','fragment','hasard','id_article','id_auteur','id_enfant','id_groupe','id_mot','id_parent','id_rubrique','id_rubrique', 'id_secteur', 'id_secteur','inverse','lang','NOT IN','num','origine_traduction','page','page_precedent_suivant','par','points','par titre','precedent_suivant','recherche','titre','titre_mot','type_mot','tout','traduction'
            )
        ),
    'SYMBOLS' => array(
        1 => array(
    ...
    'URLS' => array(
        ...
        4 => '',
		5 => 'http://www.linux-live-cd.org/{FNAMEL}'
        ),
    'OOLANG' => true,
