...
?>
Derni&egrave;re modification du code sur trac: il y a <b></b><br/>
[#sommaire<-]
...
<?php
echo '[#/var/www/clients/client1/web2/vs-dev/console/console_boutons.php<-]/var/www/clients/client1/web2/vs-dev/console/console_boutons.php - <div class="actions_fichier"> <img src="http://www.codes-libres.org/trac_plugin.png" width=15px height=15px/>[Voir ce fichier sur le trac de spip-> http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/console_boutons.php] <img src="http://www.codes-libres.org/arrow-download.png" width=15px height=15px/>[Telecharger le fichier->http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/console_boutons.php?format=txt] <br /> <img src="http://www.codes-libres.org/menu.png" width=15px height=15px/> [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - <img src="http://www.codes-libres.org/function.png" width=25px height=22px/> [Retour &agrave; la liste des fonctions->#fFCT]</div>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/console_boutons.php');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/console_boutons.php');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/console_boutons.php", $lookup);
echo $geshi2->parse_code();
echo '[#/var/www/clients/client1/web2/vs-dev/console/console_options.php<-]/var/www/clients/client1/web2/vs-dev/console/console_options.php - <div class="actions_fichier"> <img src="http://www.codes-libres.org/trac_plugin.png" width=15px height=15px/>[Voir ce fichier sur le trac de spip-> http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/console_options.php] <img src="http://www.codes-libres.org/arrow-download.png" width=15px height=15px/>[Telecharger le fichier->http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/console_options.php?format=txt] <br /> <img src="http://www.codes-libres.org/menu.png" width=15px height=15px/> [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - <img src="http://www.codes-libres.org/function.png" width=25px height=22px/> [Retour &agrave; la liste des fonctions->#fFCT]</div>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/console_options.php');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/console_options.php');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/console_options.php", $lookup);
echo $geshi2->parse_code();
echo '[#/var/www/clients/client1/web2/vs-dev/console/exec/console_ahah.php<-]/var/www/clients/client1/web2/vs-dev/console/exec/console_ahah.php - <div class="actions_fichier"> <img src="http://www.codes-libres.org/trac_plugin.png" width=15px height=15px/>[Voir ce fichier sur le trac de spip-> http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/console_ahah.php] <img src="http://www.codes-libres.org/arrow-download.png" width=15px height=15px/>[Telecharger le fichier->http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/console_ahah.php?format=txt] <br /> <img src="http://www.codes-libres.org/menu.png" width=15px height=15px/> [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - <img src="http://www.codes-libres.org/function.png" width=25px height=22px/> [Retour &agrave; la liste des fonctions->#fFCT]</div>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/exec/console_ahah.php');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/exec/console_ahah.php');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/exec/console_ahah.php", $lookup);
echo $geshi2->parse_code();
echo '[#/var/www/clients/client1/web2/vs-dev/console/exec/console.php<-]/var/www/clients/client1/web2/vs-dev/console/exec/console.php - <div class="actions_fichier"> <img src="http://www.codes-libres.org/trac_plugin.png" width=15px height=15px/>[Voir ce fichier sur le trac de spip-> http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/console.php] <img src="http://www.codes-libres.org/arrow-download.png" width=15px height=15px/>[Telecharger le fichier->http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/console.php?format=txt] <br /> <img src="http://www.codes-libres.org/menu.png" width=15px height=15px/> [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - <img src="http://www.codes-libres.org/function.png" width=25px height=22px/> [Retour &agrave; la liste des fonctions->#fFCT]</div>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/exec/console.php');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/exec/console.php');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/exec/console.php", $lookup);
echo $geshi2->parse_code();
echo '[#/var/www/clients/client1/web2/vs-dev/console/exec/console_popup.php<-]/var/www/clients/client1/web2/vs-dev/console/exec/console_popup.php - <div class="actions_fichier"> <img src="http://www.codes-libres.org/trac_plugin.png" width=15px height=15px/>[Voir ce fichier sur le trac de spip-> http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/console_popup.php] <img src="http://www.codes-libres.org/arrow-download.png" width=15px height=15px/>[Telecharger le fichier->http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/console_popup.php?format=txt] <br /> <img src="http://www.codes-libres.org/menu.png" width=15px height=15px/> [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - <img src="http://www.codes-libres.org/function.png" width=25px height=22px/> [Retour &agrave; la liste des fonctions->#fFCT]</div>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/exec/console_popup.php');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/exec/console_popup.php');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/exec/console_popup.php", $lookup);
echo $geshi2->parse_code();
echo '[#/var/www/clients/client1/web2/vs-dev/console/exec/spiplog.php<-]/var/www/clients/client1/web2/vs-dev/console/exec/spiplog.php - <div class="actions_fichier"> <img src="http://www.codes-libres.org/trac_plugin.png" width=15px height=15px/>[Voir ce fichier sur le trac de spip-> http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/spiplog.php] <img src="http://www.codes-libres.org/arrow-download.png" width=15px height=15px/>[Telecharger le fichier->http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/exec/spiplog.php?format=txt] <br /> <img src="http://www.codes-libres.org/menu.png" width=15px height=15px/> [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - <img src="http://www.codes-libres.org/function.png" width=25px height=22px/> [Retour &agrave; la liste des fonctions->#fFCT]</div>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/exec/spiplog.php');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/exec/spiplog.php');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/exec/spiplog.php", $lookup);
echo $geshi2->parse_code();
echo '[#/var/www/clients/client1/web2/vs-dev/console/inc/console.php<-]/var/www/clients/client1/web2/vs-dev/console/inc/console.php - <div class="actions_fichier"> <img src="http://www.codes-libres.org/trac_plugin.png" width=15px height=15px/>[Voir ce fichier sur le trac de spip-> http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/inc/console.php] <img src="http://www.codes-libres.org/arrow-download.png" width=15px height=15px/>[Telecharger le fichier->http://zone.spip.org/trac/spip-zone/browser/_plugins_//var/www/clients/client1/web2/vs-dev/console/inc/console.php?format=txt] <br /> <img src="http://www.codes-libres.org/menu.png" width=15px height=15px/> [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - <img src="http://www.codes-libres.org/function.png" width=25px height=22px/> [Retour &agrave; la liste des fonctions->#fFCT]</div>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/inc/console.php');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/inc/console.php');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/inc/console.php", $lookup);
echo $geshi2->parse_code();
?>
<hr/>
...
<p><img src=../go-up.png alt=retour sommaire title=Retour au sommaire />[Retour au sommaire->#sommaire]</p>
<?php
echo '<p name=/var/www/clients/client1/web2/vs-dev/console/console.html>[#/var/www/clients/client1/web2/vs-dev/console/console.html<-]/var/www/clients/client1/web2/vs-dev/console/console.html - [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - [Retour &agrave; la liste des fonctions->#fFCT]</p>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/console.html');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/console.html');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/console.html", $lookup);
echo $geshi2->parse_code();
echo '<p name=/var/www/clients/client1/web2/vs-dev/console/logs.html>[#/var/www/clients/client1/web2/vs-dev/console/logs.html<-]/var/www/clients/client1/web2/vs-dev/console/logs.html - [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - [Retour &agrave; la liste des fonctions->#fFCT]</p>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/logs.html');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/logs.html');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/logs.html", $lookup);
echo $geshi2->parse_code();
?>
<hr/>
...
<p><img src=../go-up.png alt=retour sommaire title=Retour au sommaire />[Retour au sommaire->#sommaire]</p>
<?php
echo '<p>[#/var/www/clients/client1/web2/vs-dev/console/plugin.xml<-]/var/www/clients/client1/web2/vs-dev/console/plugin.xml - [Retour &agrave; la liste des r&eacute;pertoires et fichiers->#tree] - [Retour &agrave; la liste des fonctions->#fFCT]</p>';
$geshi2->set_header_content('Debut du fichier /var/www/clients/client1/web2/vs-dev/console/plugin.xml');
$geshi2->set_footer_content('Fin du fichier /var/www/clients/client1/web2/vs-dev/console/plugin.xml');
$geshi2->load_from_file("/iso/sites/codes-libres/dezip-clean//var/www/clients/client1/web2/vs-dev/console/plugin.xml", $lookup);
echo $geshi2->parse_code();
?>
<hr/>
